...
cd ${ENVDIR} && ${WEBOTS_HOME}/webots --batch --stream ./projects/worlds/khepera4.wbt  &
WEBOTS_ID=$!

cd ${ENVDIR} && jupyter lab --ip=0.0.0.0 --NotebookApp.token='' --NotebookApp.notebook_dir='notebooks'
